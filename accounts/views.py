...
@login_required(login_url='login')  # if a person is not logged in, they will be sent to a login page
...
def forgot_password(request):
    if request.method == 'POST':
        ...
        if User.objects.filter(email=email).exists():
            ...
            messages.error(request, 'The email you provided does not exist.')
